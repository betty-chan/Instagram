...
-- ----------------------------
BEGIN;
INSERT INTO `discuss` VALUES (10, 1, 'a9445c646fd54a3d950f52df473c0380', 'shawzhou', '我的�?, '2018-11-12 07:47:19.0000', '2018-11-12 07:47:19.0000');
INSERT INTO `discuss` VALUES (11, 1, 'a9445c646fd54a3d950f52df473c0380', 'shawzhou', '呜呜�?, '2018-11-12 07:47:21.0000', '2018-11-12 07:47:21.0000');
INSERT INTO `discuss` VALUES (12, 1, 'a9445c646fd54a3d950f52df473c0380', 'shawzhou', '哈哈�?, '2018-11-12 07:47:24.0000', '2018-11-12 07:47:24.0000');
...
INSERT INTO `discuss` VALUES (16, 1, 'a9445c646fd54a3d950f52df473c0380', 'shaw', '我的�?=@__@=)哪里�?, '2018-11-14 09:17:17.0000', '2018-11-14 09:17:17.0000');
...
CREATE TABLE `follow` (
  ...
  `status` int(1) NOT NULL COMMENT '关注状�?0:取消关注 1:已关�?,
  `created_at` datetime NOT NULL COMMENT '创建时间',
  `updated_at` datetime NOT NULL COMMENT '最后更新时�?,
  PRIMARY KEY (`id`)
...
CREATE TABLE `topic` (
  `topic_id` int(10) NOT NULL AUTO_INCREMENT COMMENT '帖子唯一id',
  `user_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '用户id',
  ...
  `updated_at` datetime NOT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '帖子最后更新时�?,
...
-- ----------------------------
BEGIN;
INSERT INTO `topic` VALUES (1, 'a9445c646fd54a3d950f52df473c0380', '用户四帖�?, '[\"http://p0.ifengimg.com/pmop/2017/1102/901DB09B75FD0FB5422F657D8706E493B04A10ED_size115_w1200_h675.jpeg\",\"https://upload.wikimedia.org/wikipedia/commons/thumb/f/f0/Raijin-ogata-emuseum.JPG/300px-Raijin-ogata-emuseum.JPG\"]', '2018-11-05 01:45:40', '2018-11-05 01:45:40', '');
...
CREATE TABLE `topic_like` (
  ...
  `user_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '用户id',
  `topic_id` int(10) NOT NULL COMMENT '帖子id',
  `status` int(1) NOT NULL COMMENT '点赞状�?:有效�?0:无效�?,
...
-- ----------------------------
BEGIN;
INSERT INTO `users` VALUES (3, 'cbd6eb6093e74c7290aad936e8a9a2cd', 'shawzhou', '466150516@qq.com', '111111', 'http://piyhxgz90.bkt.clouddn.com/1543653964188头像.jpg', NULL, '86', '�?, '2018-12-01 08:45:12', '2018-12-01 08:46:09', '我是一个球�?);
INSERT INTO `users` VALUES (4, 'e51c2d2e4366433fb35f017c69468149', 'woshishui', 'codingzx@gmail.com', '111111', 'http://piyhxgz90.bkt.clouddn.com/1543654269146风景.jpg', NULL, '86', '�?, '2018-12-01 08:47:47', '2018-12-01 08:52:30', '风景专家');
INSERT INTO `users` VALUES (5, 'daabb0b0a90244a5b3204ac6779708dc', 'wuwan', 'wuwantian@gmail.com', '111111', 'http://piyhxgz90.bkt.clouddn.com/15436544923382531170_182711296228_2.jpg', NULL, '86', '�?, '2018-12-01 08:52:49', '2018-12-01 08:54:58', NULL);
COMMIT;
